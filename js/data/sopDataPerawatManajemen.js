...
const sopDataPerawatManajemen = [
    ...
    },
    {
        ...
        prosedur: [
            ...
            { desc: 'Kontrol yang dilakukan meliputi: Kondisi umum pasien dengan melakukan komunikasi terapeutik, Kelancaran tetesan infus, Vital sign: nadi' },
        ...
        prosedur: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { desc: 'Untuk Jenazah dipulasara di rumah: Alat-alat yang terpasang dilepas, jenazah dibersihkan, mulut dikatupkan dengan kasa, mata dan telinga ditutup, tangan disedekapkan, lutut dan pergelangan kaki dirapatkan, tubuh dibungkus kain kafan' },
                    ...
                    { desc: 'Untuk Jenazah yang dipulasara di rumah sakit: Dilakukan perawatan jenazah, kemudian diantar ke ruang pemulasaraan jenazah' },
                    { desc: 'Perawat menyerahkan surat keterangan kematian dan berkas pemeriksaan penunjang' },
                    { desc: 'Perawat memberitahu dokter yang merawat' },
                    { desc: 'Tempat tidur dibereskan, rekam medis dilengkapi dan diantar ke rekam medis' }
                ]
            }
        ],
    ...
    },
    {
        ...
        prosedur: [
            ...
            {
                step: 'Pelaksanaan - Antar Ruangan (Rawat Inap ke Rawat Inap)',
                items: [
            ...
            {
                step: 'Pelaksanaan - Rawat Inap ke Ruang Perawatan Khusus (ICU/HCU)',
                items: [
                    { desc: 'Perawat menyampaikan informed consent kepada keluarga tentang rencana pemindahan' },
                    { desc: 'Perawat ruangan menghubungi ruangan khusus untuk memesan kamar' },
                    { desc: 'Pasien disiapkan dan dirapihkan, kemudian diantar ke ICU/HCU' },
                    { desc: 'Melakukan serah terima pasien' },
                    { desc: 'Petugas ruangan membereskan kamar perawatan' }
                ]
            },
            {
                step: 'Pelaksanaan - Ruang Perawatan Khusus ke Rawat Inap',
                items: [
                    { desc: 'Perawat menyampaikan informed consent bahwa pasien sudah dapat pindah' },
            ...
            {
                step: 'Pelaksanaan - Ruang Perawatan Khusus ke Ruang Perawatan Khusus (ICU ke HCU)',
                items: [
                    { desc: 'Perawat menyampaikan informed consent kepada keluarga' },
                    { desc: 'Perawat menghubungi ruangan yang dituju untuk memesan kamar' },
                    { desc: 'Pasien disiapkan dan dirapihkan, kemudian diantar ke ruangan tujuan' },
                    { desc: 'Melakukan serah terima pasien' },
                    { desc: 'Petugas ruangan membereskan kamar perawatan' }
                ]
            },
            {
                step: 'Pelaksanaan - Rawat Inap melalui Kamar Bedah ke Rawat Inap Lain',
                items: [
                    { desc: 'Perawat ruangan menghubungi ruangan yang dituju untuk memesan kamar paska operasi' },
                    { desc: 'Perawat menyampaikan informed consent kepada keluarga' },
                    { desc: 'Pasien disiapkan dan diantar ke kamar bedah sesuai jadwal' },
                    { desc: 'Melakukan serah terima dengan perawat kamar bedah' },
                    { desc: 'Bila operasi selesai, perawat kamar bedah menghubungi perawat ruangan asal dan ruangan tujuan' },
                    { desc: 'Melakukan serah terima di kamar bedah antara perawat ruangan sebelumnya, kamar bedah, dan ruangan tujuan' },
                    { desc: 'Perawat ruangan tujuan membawa pasien ke ruangan' }
                ]
            },
            {
                step: 'Pelaksanaan - IGD/IRJ melalui Kamar Bedah ke Rawat Inap',
                items: [
                    ...
                    { desc: 'Perawat kamar bedah melakukan serah terima dengan perawat ruangan tujuan' }
                ]
            },
            {
                step: 'Pelaksanaan - Rawat Inap melalui Kamar Bedah ke Ruang Perawatan Khusus',
                items: [
                    ...
                    { desc: 'Perawat kamar bedah melakukan serah terima dengan perawat ruangan' },
                    { desc: 'Perawat ruangan membawa pasien ke ruangan ICU/HCU dan melakukan serah terima' }
                ]
            }
        ],
        ...
        prosedur: [
            {
                step: 'Persiapan',
                items: [
                    { desc: 'Persiapan kelengkapan operan: Buku komunikasi, Status Pasien, Hal-hal lain yang diperlukan' },
                    { desc: 'Persiapan petugas: Semua petugas sudah siap di nurse station' }
                ]
            },
            {
                step: 'Pelaksanaan di Nurse Station',
                items: [
            ...
            {
                step: 'Pelaksanaan Timbang Terima di Sisi Pasien',
                items: [
                    { desc: 'Kepala Ruangan/PP/Pgj Shift melakukan timbang terima pasien secara berkeliling sesuai timnya' },
                    { desc: 'Mengucapkan salam (Assalamualaikum, selamat pagi/siang/sore)' },
                    ...
                    { desc: 'Khusus operan malam ke pagi, ada perawat yang memimpin berdoa di depan pasien dan keluarga secara bergiliran' }
                ]
            },
            {
                step: 'Pasca Operan',
        ...
        prosedur: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { desc: 'Panduan: Persiapan, Operan, Pre Conference, Cek SDM, Cek kebutuhan pasien, Interaksi dengan pasien, Supervisi Tim I, II, III, Rapat Koordinasi, Istirahat, Cek ulang pasien, Buat RTL harian, Buat laporan, Operan' }
                ]
            },
            {
                ...
                items: [
                    ...
                    { desc: 'Panduan: Melihat jadwal dinas, Operan, Pre conference, Merapihkan tempat tidur, Mengidentifikasi pemeriksaan diagnostik, Melengkapi pengkajian klien baru, Mengatur konsul, Mengevaluasi/membuat renpra, Diskusi dengan dokter, Melaksanakan tindakan, Monitoring dan membimbing PA, Dokumentasi SOAP, Menyusun RTL, Isoma, Pendidikan kesehatan, Post conference, Operan, Mengarahkan PA Sore' }
                ]
            },
            {
                step: 'Rencana Kerja Harian Perawat Associate',
                items: [
                    { desc: 'Berisi: Kegiatan Rutin, Pelaksanaan Asuhan Keperawatan, Evaluasi Formatif' },
                    { desc: 'Panduan: Nama PA, Hari dan tanggal, Persiapan, Operan, Pre Conference, Interaksi dengan pasien dalam melaksanakan tindakan keperawatan, Evaluasi Formatif, Post Conference, Istirahat' }
                ]
            }
        ],
    ...
    },
    {
        ...
        prosedur: [
            { desc: 'Kepala Ruangan mengatur jadwal kontrol kepada pasien dan masuk ke dalam rencana harian kerja' },
            { desc: 'Perawat Primer/Ketua Tim mengatur jadwal kontrol ke pasien dalam wilayah kerjanya dengan membagi tugas kepada PA' },
            { desc: 'Kontrol yang dilakukan meliputi: Kondisi umum pasien dengan komunikasi terapeutik, Kelancaran tetesan infus, Vital sign: nadi' },
            { desc: 'Hasil kontrol dicatat dalam lembar observasi pasien' },
            { desc: 'Apabila ada hal-hal yang penting atau ada masalah segera dilaporkan ke PP/Katim dan kepala ruangan untuk ditindaklanjuti' }
        ],
        dokumenTerkait: ['Rekam medik pasien', 'Rencana Kerja Harian'],
